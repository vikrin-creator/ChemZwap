...
if (!defined('DB_HOST')) define('DB_HOST', 'srv2124.hstgr.io');
...
// Email Configuration
if (!defined('EMAIL_USER')) define('EMAIL_USER', 'sainithin95054@gmail.com');
if (!defined('EMAIL_PASS')) define('EMAIL_PASS', 'mpsx wgsq uhve hygs');
if (!defined('ADMIN_EMAIL')) define('ADMIN_EMAIL', 'sainithin95054@gmail.com');

// Server Configuration
if (!defined('API_URL')) define('API_URL', 'http://localhost:8000');

// Error Reporting
$displayErrors = defined('DISPLAY_ERRORS') ? DISPLAY_ERRORS : 1;
